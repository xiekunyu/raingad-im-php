...
ALTER TABLE `yu_user` ADD `friend_limit` INT(11) NOT NULL DEFAULT '0' COMMENT '好友上限' AFTER `setting`, ADD `group_limit` INT(11) NOT NULL DEFAULT '0' COMMENT '群聊上限' AFTER `firend_limit`;